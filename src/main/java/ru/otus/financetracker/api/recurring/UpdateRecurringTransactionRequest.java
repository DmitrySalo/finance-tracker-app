...
public record UpdateRecurringTransactionRequest(@NotNull @PositiveOrZero Long version, UUID categoryId,
                                               ...
                                               @Size(max = 1000) String description, TransactionType transactionType,
                                               @Min(1) @Max(31) Integer dayOfMonth, LocalDate startDate, Boolean active) {
}
