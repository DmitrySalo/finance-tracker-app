...
public record BudgetCalculation(Budget budget, BigDecimal spentAmount, BigDecimal remainingAmount, BigDecimal percentage) {
    ...
    public static BudgetCalculation from(Budget budget, BigDecimal spentAmount) {
        ...
        BigDecimal remainingAmount = budget.limitAmount().subtract(roundedSpentAmount).setScale(MONEY_SCALE);
