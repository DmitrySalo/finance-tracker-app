...
class AuditLogControllerIntegrationTests extends PostgresIntegrationTestSupport {
    ...
    @Test
    @DisplayName("Журнал аудита возвращает только записи текущего пользователя по заданному ресурсу")
