...
### Шаг 42
Провёл функциональное тестирование через UI с помощью агента.

[Промт.](promts/funtional-ui-testing.md)

### Шаг 43
Провёл финальную ретроспективу:
1. Проект оказался дороже, чем я думал.
2. Качественные планирование и подготовка рабочей среды (инструкции, ТЗ) значительно ускоряют разработку и повышают качество итогового продукта.

### Шаг 44
Добавить подробную инструкцию демонстрационного запуска с seed-данными и данные демонстрационных аккаунтов.
